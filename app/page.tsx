...
export const metadata: Metadata = {
  ...
  description:
    'Apple iPhone, Samsung, Google Pixel, Sony, OnePlus & more — premium smartphones, laptops and accessories in Kenya. Shop ex-UK deals at Kimathi House 5th Floor Suite 504. Call 0142530781.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
