      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-white font-bold text-xl mb-4 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
              {brandConfig.name}
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>info@shwariphones.com</span>
              </li>
              <li className="flex items-start gap-3 text-gray-400">
                <svg className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
