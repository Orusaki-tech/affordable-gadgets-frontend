        ...
        <div className="product-detail__info">
          ...
          <div className="product-detail__info-header">
            <div className="product-detail__header-top">
              <span className="product-detail__certified-pill">
                Certified {selectedUnitData?.condition === 'R' ? 'Refurbished' : 'Device'}
              </span>
            </div>
          ...
          {/* Payment helper text */}
          <div className="product-detail__payment-note">
            <span className="product-detail__payment-main">
              {selectedUnitData ? 'Pay in full or with flexible installments.' : 'Select a variant to see pricing and payment options.'}
            </span>
            <span className="product-detail__payment-alt">
              Secure checkout with M‑Pesa and cards.
            </span>
          </div>

          {/* Payment methods strip */}
          <div className="product-detail__payments-row">
            <span className="product-detail__payments-label">We accept</span>
            <div className="product-detail__payments-logos">
              <span className="product-detail__payments-chip">VISA</span>
              <span className="product-detail__payments-chip">Mastercard</span>
              <span className="product-detail__payments-chip">M‑Pesa</span>
              <span className="product-detail__payments-chip">PayPal</span>
            </div>
          </div>
            ...
            <div className="product-detail__cta">
              ...
              <div className="product-detail__cta-actions">
                ...
                <button
                  ...
                  className="product-detail__cta-button product-detail__cta-button--secondary"
                  disabled={!selectedUnit || isAddingToCart}
                >
                  Buy Now
                </button>
